                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    <form action="" method="post" class="form-horizontal">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                ...
                                                <select name="select" id="person" class="form-control">
                                                    ...
                                                    <% JSONArray ja=(JSONArray)session.getAttribute("nid");
                                        ...
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="hf-password" class=" form-control-label">Bill Number</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="billno" name="text-input" placeholder="Text" class="form-control"><small class="form-text text-muted">This is a help text</small></div>
                                        </div>
                                     <div  id="row">
