...
public class IssueNoteReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            System.out.println("------in get----jasper");
...
//        
        ...
        int n=Integer.parseInt(request.getParameter("ino"));
        System.out.println("---index--jasper----67....."+n);
        parameters.put("parameter2", n);
